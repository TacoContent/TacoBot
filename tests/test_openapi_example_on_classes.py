...
def test_example_validation_on_class():
    ...
    with pytest.raises(ValueError, match="One of 'value', 'externalValue', or 'schema' must be provided"):
        ...
        @openapi.example(name="invalid", placement="schema")
        class TestRoleMissingExample:
            pass
...
def test_example_with_none_value_on_class():
    ...
    @openapi.example(name="null_example", value=None, placement="schema", summary="Null value example")
    class TestRole:
        pass
...
def test_example_preserves_class_functionality():
    ...
    @openapi.example(name="test", value={"id": "123"}, placement="schema")
    class TestRole:
