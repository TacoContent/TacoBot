...
class TestTacoBotMetricsInitialization:
    ...
    def test_initialization_success(self, metrics_config, metrics_db, settings):
        """Test that TacoBotMetrics initializes correctly with all dependencies."""
        metrics = TacoBotMetrics(metrics_config, metrics_db, settings)
    ...
    def test_initialization_creates_all_gauges(self, metrics_config, metrics_db, settings):
    ...
    def test_initialization_with_valid_log_level(self, metrics_config, metrics_db, settings):
        """Test initialization with valid log level from settings."""
        settings.log_level = "DEBUG"

        with patch("metrics.tacobot.Gauge"):
            TacoBotMetrics(metrics_config, metrics_db, settings)

    def test_initialization_with_invalid_log_level(self, metrics_config, metrics_db, settings):
    ...
    def test_initialization_sets_module_and_class_names(self, metrics_config, metrics_db, settings):
    ...
    def test_initialization_calls_fetch_build_info(self, metrics_config, metrics_db, settings):
    ...
    def test_initialization_gauge_error_handling(self, metrics_config, metrics_db, settings):
...
class TestTacoBotMetricsGaugeSetup:
    ...
    def test_gauge_labels_setup(self, metrics_config, metrics_db, settings):
    ...
    def test_user_metrics_have_user_labels(self, metrics_config, metrics_db, settings):
    ...
    def test_healthy_gauge_has_no_labels(self, metrics_config, metrics_db, settings):
    ...
    def test_build_info_gauge_has_version_labels(self, metrics_config, metrics_db, settings):
    ...
    def test_all_gauges_have_namespace(self, metrics_config, metrics_db, settings):
    ...
    def test_all_gauges_have_documentation(self, metrics_config, metrics_db, settings):
...
class TestTacoBotMetricsEnvironmentVariables:
    ...
    def test_build_info_reads_environment_variables(self, metrics_config, metrics_db, settings):
    ...
    def test_build_info_uses_defaults_when_env_vars_missing(self, metrics_config, metrics_db, settings):
