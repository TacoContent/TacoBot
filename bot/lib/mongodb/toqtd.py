...
class TQOTDDatabase(Database):
    ...
    def save_tqotd(self, guildId: int, question: str, author: int) -> None:
        ...
        try:
            ...
            self.connection.tqotd.update_one(  # type: ignore
        ...
        try:
            ...
            if result:
                ...
                if result:
                    ...
                    raise Exception(f"No TQOTD found for guild {guildId} for today or yesterday")
        except Exception as ex:
            self.log(
                guildId=guildId,
                level=loglevel.LogLevel.ERROR,
    ...
    def get_all_tqotd_questions(self, guildId: int):
        ...
        try:
            ...
            result = self.connection.tqotd.find({}).sort([("timestamp", -1)])  # type: ignore
