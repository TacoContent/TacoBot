...
class Giphy(TacobotCog):
    def __init__(self, bot: TacoBot, message_helper: MessageHelper, tracking_db: TrackingDatabase, settings: Settings):
...
async def setup(bot):
    ...
    await bot.add_cog(Giphy(bot=bot, message_helper=message_helper, tracking_db=tracking_db, settings=settings))
